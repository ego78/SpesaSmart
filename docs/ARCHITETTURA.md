...
PWA statica pubblicabile su GitHub Pages;
connettori Node.js eseguiti da GitHub Actions;
file JSON versionati usati come archivio delle offerte;
Google Apps Script opzionale per sincronizzare i dati familiari.
Flusso attuale
```text
